...
public class MeetingMinutesTest {
    ...
    private static MongoHelper mongoHelper;
        ...
        void createMeetingMinutesApiTest() throws JsonProcessingException {
                ...
                Agenda agenda = new Agenda("PAM issue", "2hours","Bala","Explained about PAM issue");
                list1.add(agenda);
                MeetingMinutes minutes = MeetingMinutes.builder().id(null)
                                .employeeName("Surendhar").projectName("citi ci").projectId("45").meetingMinutesId(null)
                                .date("2023-04-10").startTime("10:00 AM").endTime("12:00 PM").meetingObjective("Discussed about the CI issue").
                                attendeesPresent(list).agenda(list1)
                                .build();
